...
class CreateThredded < ActiveRecord::Migration[7.0]
  def change
    ...
    unless table_exists?(:thredded_private_topics)
    ...
    unless table_exists?(:thredded_private_users)
    ...
    unless table_exists?(:thredded_topic_categories)
    ...
    unless table_exists?(:thredded_topics)
    ...
    unless table_exists?(:thredded_user_details)
    ...
    unless table_exists?(:thredded_messageboard_users)
    ...
    unless table_exists?(:thredded_user_preferences)
    ...
    unless table_exists?(:thredded_user_messageboard_preferences)
    ...
    unless table_exists?(:thredded_messageboard_groups)
    ...
    unless table_exists?(:thredded_user_topic_follows)
    ...
    unless table_exists?(:thredded_post_moderation_records)
