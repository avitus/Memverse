...
class AddRpush < ActiveRecord::Migration[7.0]
  ...
  class CreateRapnsNotifications < ActiveRecord::Migration[7.0]
    def self.up
  ...
  class CreateRapnsFeedback < ActiveRecord::Migration[7.0]
    def self.up
  ...
  class AddAlertIsJsonToRapnsNotifications < ActiveRecord::Migration[7.0]
    def self.up
  ...
  class AddAppToRapns < ActiveRecord::Migration[7.0]
    def self.up
  ...
  class CreateRapnsApps < ActiveRecord::Migration[7.0]
    def self.up
  ...
  class AddGcm < ActiveRecord::Migration[7.0]
    module Rapns
  ...
  class AddWpns < ActiveRecord::Migration[7.0]
    module Rapns
      class Notification < ActiveRecord::Base
        self.table_name = 'rapns_notifications'
      end
  ...
  class AddAdm < ActiveRecord::Migration[7.0]
    module Rapns
      class Notification < ActiveRecord::Base
        self.table_name = 'rapns_notifications'
      end
  ...
  class RenameRapnsToRpush < ActiveRecord::Migration[7.0]
    module Rpush
      class App < ActiveRecord::Base
  ...
  class AddFailAfterToRpushNotifications < ActiveRecord::Migration[7.0]
    def self.up
