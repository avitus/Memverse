...
ActiveRecord::Schema.define(version: 20170420163138) do
  ...
  create_table "tweets", force: :cascade do |t|
    ...
    t.integer  "user_id",           limit: 4
    t.integer  "church_id",         limit: 4
    t.integer  "american_state_id", limit: 4
    t.integer  "country_id",        limit: 4
  ...
  create_table "uberverses", force: :cascade do |t|
    t.string  "book",           limit: 255, null: false
    t.integer "chapter",        limit: 4,   null: false
    t.integer "versenum",       limit: 4,   null: false
    t.integer "book_index",     limit: 4
    t.integer "subsection_end", limit: 4
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "reminder_freq",             limit: 255, default: "weekly"
    t.boolean  "newsletters",                           default: true
    t.integer  "church_id",                 limit: 4
    t.integer  "country_id",                limit: 4
    t.string   "language",                  limit: 255, default: "English"
    t.integer  "time_allocation",           limit: 4,   default: 5
    t.integer  "memorized",                 limit: 4,   default: 0
    t.integer  "learning",                  limit: 4,   default: 0
    t.date     "last_activity_date"
    t.boolean  "show_echo",                             default: true
    t.integer  "max_interval",              limit: 4,   default: 366
    t.string   "mnemonic_use",              limit: 255, default: "Learning"
    t.integer  "american_state_id",         limit: 4
    t.integer  "accuracy",                  limit: 4,   default: 10
    t.boolean  "all_refs",                              default: true
    t.integer  "rank",                      limit: 4
    t.integer  "ref_grade",                 limit: 4,   default: 10
  ...
  create_table "verses", force: :cascade do |t|
    ...
    t.integer  "book_index",      limit: 4,                                             null: false
    t.string   "book",            limit: 255,                                           null: false
    t.integer  "chapter",         limit: 4,                                             null: false
    t.integer  "versenum",        limit: 4,                                             null: false
    t.text     "text",            limit: 65535
    ...
    t.integer  "uberverse_id",    limit: 4
    t.string   "checked_by",      limit: 255
    t.integer  "memverses_count", limit: 4,                             default: 0
