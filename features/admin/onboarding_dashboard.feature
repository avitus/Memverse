Feature: Admin Onboarding Dashboard
  ...
  Scenario: Viewing the onboarding dashboard
    ...
    And I should see "3" new users in the past 14 days
  ...
  Scenario: Filtering users by progression level
    Given I am on the onboarding dashboard page
    When I select "5-6: Engaged" from "Progression Level"
  ...
  Scenario: Filtering users by email confirmation status
    Given I am on the onboarding dashboard page
    When I select "Unconfirmed" from "Email Status"
    And I click "Apply Filters"
  ...
  Scenario: Viewing detailed user information
    ...
    And I should see "Progression Level: 5 - Engaged"
    And I should see "Email: newuser1@example.com ✓"
  ...
  Scenario: Sending emails to unengaged users
    ...
    When I click "Email Unengaged Users"
    And I confirm the action
    Then reminder emails should be sent to unengaged users
    And I should see "Reminder emails sent to 1 unengaged users"

  Scenario: Accessing admin dashboard as non-admin
    Given I am logged in as a regular user
    When I try to visit the admin onboarding dashboard
    Then I should be redirected to the home page
    And I should see "You must be an admin to access this page"

  Scenario: Changing date range
    Given I am on the onboarding dashboard page
    When I select "Last 30 days" from "Date Range"
    And I click "Apply Filters"
    Then I should see "4" new users
