...
TRANSLATIONS = {
  ...
  NAS:    {name: "New American Standard Bible (1995)", language: "en"},
  NKJ:    {name: "New King James Version (1982)", language: "en"},
  ...
  NLT15:  {name: "New Living Translation (2015)", language: "en"},
  CEV:    {name: "Contemporary English Version (1995)", language: "en"},
  ...
  GEN:    {name: "Geneva Bible (1599)", language: "en"},
  GRK:    {name: "Biblical Greek (SBLGNT) (2010)", language: "en"},
  ...
  GW:     {name: "God's Word Translation (1995)", language: "en"},
  GNT:    {name: "Good News Translation (1992)", language: "en"},
