...
const verseFeedback = memverse.verseFeedback;

describe("Feedback", () => {
	it("should be correct even with incorrect punctuation", () => {
	...
	it("does not give away complete number when only first numeral has been provided", () => {
		expect(verseFeedback(
			"And after he became the father of Enosh, Seth lived 807 years and had other sons and daughters.",	// correct text
	...
	it("does give number when number is correct", () => {
		expect(verseFeedback(
			"And after he became the father of Enosh, Seth lived 807 years and had other sons and daughters.",	// correct text
	...
	it("should not accept Spanish without special characters", () => {
		expect(verseFeedback(
	...
	it("should support all sorts of languages", () => {
		expect(verseFeedback(
	...
	it("should accept first letter if mnemonic disabled", () => {
		expect(verseFeedback(
	...
	it("should accept accented first letters if mnemonic disabled", () => {
		expect(verseFeedback(
	...
	it("should recognize last first-letter without a subsequent space or punctuation mark", () => {
		expect(verseFeedback(
	...
	it("should accept some complete words in text that's primarily first letters", () => {
		expect(verseFeedback(
	...
	it("should not give feedback if disabled", () => {
		expect(verseFeedback(
			'This is a test',		// correct text
			'T i',					// user guess
			false,					// feedback
	...
	it("should not give feedback if disabled but still say if correct", () => {
		expect(verseFeedback(
			'This is a test.',		// correct text
	...
	it("should give ... to an incorrect first first letter even when first letter is disabled", () => {
		expect(verseFeedback(
			'This is a test',		// correct text
			'T',					// user guess
			true,					// feedback
	...
	it("should detect any two subsequent single letters as first letters", () => {
		expect(verseFeedback(
	...
	it('accepts Korean "first letters"', () => {
		expect(verseFeedback(
