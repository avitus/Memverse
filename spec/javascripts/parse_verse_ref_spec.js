describe("parseVerseRef", function() {
  ...
  describe("in English", function () {
    ...
    it("accepts Roman numerals", function() {
    ...
    it("accepts incorrectly capitalized Roman numerals", function(){
      expect(parseVerseRef("Ii John 1:2")).toEqual({ bk: '2 John', ch: 1, vs: 2, bi: 63 } );
    })
