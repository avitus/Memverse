...
describe ProgressReport do
  ...
  it "should count all of the progress reports to date" do
    @pr1 = FactoryGirl.build(:progress_report, :entry_date => '2012-12-01', :user => @user)
    @pr1.save

    @pr2 = FactoryGirl.build(:progress_report, :entry_date => '2012-12-02', :user => @user)
    @pr2.save

    @pr3 = FactoryGirl.build(:progress_report, :entry_date => '2012-12-04', :user => @user)
    @pr3.save
